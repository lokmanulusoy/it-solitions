...
const Teams = () => {
  return (
    <Container>
      <TextBanner title={"Biz kimiz?"} subtitle={"Takımımız"} />
      <Wrapper>
        <Card>
          <CardImage src={avatarImage1} />
          <TextWrapper>
            <MemberName>John Doe</MemberName>
            <TeamPosition>Pazarlama Uzmanı</TeamPosition>
          </TextWrapper>
        </Card>
        <Card>
          ...
          <TextWrapper>
            ...
            <TeamPosition>Proje Müdürü</TeamPosition>
          </TextWrapper>
        </Card>
        <Card>
          ...
          <TextWrapper>
            ...
            <TeamPosition>Web Tasarımcısı</TeamPosition>
          </TextWrapper>
        </Card>
        <Card>
          ...
          <TextWrapper>
            ...
            <TeamPosition>Pazarlama Koordinatörü</TeamPosition>
          </TextWrapper>
        </Card>
      </Wrapper>
    </Container>
